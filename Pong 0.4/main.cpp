    ...
    if (!game.pausa) {
        ...
        if (game.gioco == 0) {
            ...
            if (pallina.x <= 0 || pallina.x >= screenWidth) {
                ...
                if (giocatori.at(0).punteggio < 10 && giocatori.at(1).punteggio < 10) {
...
int main(void)
{
    ...
    std::vector<Sound> suoni = {
            ...
            LoadSound("assets/rimbalzo.wav"),
            LoadSound("assets/punto.mp3"),
            LoadSound("assets/vittoria.mp3")
    };
