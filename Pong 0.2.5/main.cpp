...
void dis_colori(const int screenWidth, const int screenHeight, std::vector<Color> colori, std::vector<Color> colore, std::vector<int> scelta_elemento){
...
void selezione_colore (int &stato, int &elemento_da_colorare, std::vector<Color> &colore, std::vector<int> &scelta_elemento, std::vector<Color> colori, const int screenWidth, const int screenHeight) {
    int a = 0, b = 0;
...
int main(void)
{
    ...
    bool rimbalzo, cresci1 = true, cresci2 = false, RGB_Yes_NO = false;
    ...
    while (!WindowShouldClose()) {
        ...
        if (stato == 0) {
            ...
            selezione_colore(stato, elemento_da_colorare, colore, scelta_elemento, colori, screenWidth, screenHeight);
        }
        ...
        if (stato == 0) {
            ...
            dis_colori(screenWidth, screenHeight, colori, colore, scelta_elemento);
        } else
        if (stato == 50)
